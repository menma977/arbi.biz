      ...
      if (Auth::attempt([$type => $request->username, 'password' => $request->password])) {
        ...
        if ($user = Auth::user()) {
          ...
          return response()->json([
            ...
            "email" => $user->email,
            "hasTradedReal" => Carbon::parse($user->trade_fake ?: "last month")->diffInDays(Carbon::now()) < 1,
            "hasTradedFake" => Carbon::parse($user->trade_real ?: "last month")->diffInDays(Carbon::now()) < 1,
